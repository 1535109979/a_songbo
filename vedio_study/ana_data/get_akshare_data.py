...
data = ak.get_futures_daily(start_date="20231101", end_date="20240115", market="SHFE")
print(data)
data.to_csv('20231101-20240115.csv')

df_2305 = data[data['symbol'] == 'RB2405'].reset_index(drop=True)
df_2306 = data[data['symbol'] == 'RB2403'].reset_index(drop=True)
