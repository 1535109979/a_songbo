...
from a_songbo.vn.enums.exchange_enum import OffsetFlag, OrderPriceType, Direction, ProductClass, OrderStatus
...
STATUS_CTP2VT: Dict[str, OrderStatus] = {
    THOST_FTDC_OST_Unknown: OrderStatus.UNKNOWN,
    THOST_FTDC_OST_AllTraded: OrderStatus.ALL_TRADED,
    THOST_FTDC_OST_PartTradedNotQueueing: OrderStatus.PART_TRADED,
    THOST_FTDC_OST_NoTradeNotQueueing: OrderStatus.NO_TRADE,
    THOST_FTDC_OST_Canceled: OrderStatus.PART_TRADED,
}

# 委托类型映射
ORDER_PRICE_TYPE_VT2CTP: Dict[OrderPriceType, tuple] = {
    OrderPriceType.LIMIT: (THOST_FTDC_OPT_LimitPrice, THOST_FTDC_TC_GFD, THOST_FTDC_VC_AV),
    OrderPriceType.MARKET: (THOST_FTDC_OPT_AnyPrice, THOST_FTDC_TC_GFD, THOST_FTDC_VC_AV),
    OrderPriceType.FAK: (THOST_FTDC_OPT_LimitPrice, THOST_FTDC_TC_IOC, THOST_FTDC_VC_AV),
    OrderPriceType.FOK: (THOST_FTDC_OPT_LimitPrice, THOST_FTDC_TC_IOC, THOST_FTDC_VC_CV),
}
ORDER_PRICE_TYPE_CTP2VT: Dict[Tuple, OrderPriceType] = {
    v: k for k, v in ORDER_PRICE_TYPE_VT2CTP.items()}

# 开平方向映射
OFFSET_FLAG_VT2CTP: Dict[OffsetFlag, str] = {
    OffsetFlag.OPEN: THOST_FTDC_OF_Open,
    OffsetFlag.CLOSE: THOST_FTDC_OFEN_Close,
    OffsetFlag.CLOSE_TODAY: THOST_FTDC_OFEN_CloseToday,
    OffsetFlag.CLOSE_YESTERDAY: THOST_FTDC_OFEN_CloseYesterday,
}
OFFSET_FLAG_CTP2VT: Dict[str, OffsetFlag] = {v: k for k, v in OFFSET_FLAG_VT2CTP.items()}
